...
contract EnergyTrading {
    ...
    function matchProsumerConsumer(
        ...
        require(
            tradeAmount <= ownerships[prosumer].energyBalance,
            "Amount should be less than prosumer avaible energy"
        );
    ...
    function energyTrading(address prosumer, address consumer) public onlyDSO {
        require(
            matchRecords[prosumer][consumer].status == 1,
    ...
    function _matchEnergy(
        ...
        uint256 prosumerEnergyAvailable = ownerships[prosumer].energyBalance;
        uint256 consumerEnergyNeeded = matchRecords[prosumer][consumer]
            .matchedAmount;
    ...
    function verifyTransaction(
        ...
        string memory roleString = owner.role == 1 ? "Prosumer" : "Consumer";
